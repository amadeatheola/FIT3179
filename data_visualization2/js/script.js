...
vegaEmbed("#cons", "js/cons_choropleth_map.vg.json", {mode: "vega-lite"})
  .then(res => views["cons_choropleth_map"] = res.view)
  .catch(console.warn);

vegaEmbed("#choropleth_map", "js/prod_choropleth_map.vg.json", {mode: "vega-lite"})
  .then(res => views["prod_choropleth_map"] = res.view)
  .catch(console.warn);
...
vegaEmbed("#choropleth_map2", "js/yrchoropleth_map.vg.json", {mode: "vega-lite"})
